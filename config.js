...
//Some special chat replies
 ...
 let smallinput = budy.toLowerCase()
    ...
    if (smallinput=='bot') {
      reply (`Hello *${pushname}*, I am *${BotName}*, a WhatsApp bot made by *HARAJIT* and currently being hosted by *${OwnerName}*.  type  *${prefix}help* to get my full command list.`);
    }
...
case 'repo': case 'botrepo':
    ...
    reply(`*My Source Code:* https://github.com/HARAJIT001/Miku-MD`)
    break
...
case 'add':{     			
 ...
 case "tts":  case "texttospeech":  case "say": case "speak":{
    ...
    var replqr =  await getBuffer(`https://miku-qr--HARAJIT001.repl.co/`)
                               var qrbutton = [
